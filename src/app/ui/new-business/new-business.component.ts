...
constructor(@Inject(SESSION_STORAGE) private storage: WebStorageService, private zone: NgZone, private coordinateSuggestionService:BusinessSuggestionService,private loggedUserService:LoggedUserService ) { }
